...
import com.easoftware.webappsee.ejb.AgenteFacade;
...
public class AgenteController implements Serializable {
    ...
    @EJB
    private AgenteFacade ejbFacade;
    ...
    public static class AgenteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Agente) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + AgenteController.class.getName());
            }
        }
    }
}
