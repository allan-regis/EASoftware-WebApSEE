...
import com.easoftware.webappsee.ejb.ProjetoFacade;
...
public class ProjetoController implements Serializable {
    ...
    @EJB
    private com.easoftware.webappsee.ejb.ProjetoFacade ejbFacade;
    ...
    public static class ProjetoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Projeto) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ProjetoController.class.getName());
            }
        }
    }
}
