...
import com.easoftware.webappsee.ejb.AtividadeFacade;
...
public class AtividadeController implements Serializable {
    ...
    @EJB
    private com.easoftware.webappsee.ejb.AtividadeFacade ejbFacade;
    ...
    public static class AtividadeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Atividade) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + AtividadeController.class.getName());
            }
        }
    }
}
